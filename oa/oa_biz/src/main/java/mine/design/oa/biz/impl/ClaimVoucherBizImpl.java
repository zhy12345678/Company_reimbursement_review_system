...
import mine.design.oa.biz.ClaimVoucherBiz;
import mine.design.oa.dao.ClaimVoucherDao;
import mine.design.oa.dao.ClaimVoucherItemDao;
import mine.design.oa.dao.DealRecordDao;
...
public class ClaimVoucherBizImpl implements ClaimVoucherBiz {
    ...
    public void submit(int id) {
        ...
        List<Employee> voucherList=employeeDao.selectByDepartmentAndPost(employee.getDepartmentSn(),Contant.POST_FM);
        String voucher="";
        if(voucherList!=null&&voucherList.size()>0){
            voucher=voucherList.get(0).getSn();
            claimVoucher.setNextDealSn(voucher);
        }
